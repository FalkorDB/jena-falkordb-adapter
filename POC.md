...
### 5.4 Query: Find Friends with Their Locations
...
### 5.5 Query: Check Direct Friend Connection (ASK Query)
...
### 5.6 Query: Find Direct Friends with Occupations and Locations
